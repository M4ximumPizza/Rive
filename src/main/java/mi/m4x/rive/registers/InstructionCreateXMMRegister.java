...
/**
 * Provides static references to all 128-bit XMM registers (XMM0–XMM31).
 *
 * <p>XMM registers are part of the SSE and AVX instruction sets and are used
 * for SIMD (Single Instruction, Multiple Data) operations on packed data.</p>
 *
 * <p>This utility class offers direct access to each
 * {@link InstructionCreateRegister} representation of an XMM register.
 ...
 */
@Beta
public final class InstructionCreateXMMRegister {

    private InstructionCreateXMMRegister() {}
